...
### 2015/04 - 2015/07 Linux ARM AArch64向け SDKの構築
- 概要 AArch64(ARM 64bit)向けの SDKを構築する
- 担当: 調査, 設計, 実装, テスト


### 2015/03 - 2015/04 組込み機器向け Linux環境のデバッグ
- 概要 uClibcの C++に関連するライブラリのデバッグ
- 担当: デバッグ


### 2014/10 - 2014/12 Linux IPsec機能拡張
- 概要 Linuxに IPsecで NATが行えるようにする(IPsec NAT traversalを使わない)
- 担当: 設計, 実装, テスト


### 2014/08 - 2014/10 ITRON TCPスタック調査
- 概要 デジタルカメラ向け, ITRONの TCPスタックが, ARM Linuxに比べ, 性能が出ない問題の調査
- 担当: 調査, テスト, 性能評価


### 2014/05 - 2014/07 FreeBSD バグ修正作業
- 担当: 実装, テスト, 性能評価
- 作業内容
...
### 2013/10 - 2015/03 組込み Linux開発向け Bluetooth関連開発
...
Flash向けファイルシステム Yaffsの FreeBSD移植
- 使用言語: C言語
